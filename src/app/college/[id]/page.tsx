      ...
      <>
        ...
        <section>
          <div className="lg:pt-16 pt-10 px-10 pb-10">
            ...
            <div>
            <p
                className={`cursor-pointer px-4 ${activeSection === 'about' ? 'border-b-4 border-yellow-500 pb-2 font-bold' : ''}`}
              ...
              <p
                className={`cursor-pointer px-4 ${activeSection === 'admission' ? 'border-b-4 border-yellow-500 pb-2 font-bold' : ''}`}
                onClick={() => setActiveSection('admission')}
              >
                Offered Programs
              </p>
              <p
                className={`cursor-pointer px-4 ${activeSection === 'programs' ? 'border-b-4 border-yellow-500 pb-2 font-bold' : ''}`}
          ...
          {activeSection === "programs" && <CollageComponents params={params} activeSection={activeSection} />}
        </section>
      </>
    );
  }
