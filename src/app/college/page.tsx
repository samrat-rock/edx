...
import GridButton from '../components/gridbutton/page'
...
function page() {
    ...
    <>
      <section className='bg-gray-200 '>
        <div className='lg:pl-20 '>
            <h3 className='lg:text-5xl text-2xl lg:bg-white'>Choose your Future Collage</h3>
        </div>
  ...
  <p className='font-bold flex items-center gap-2 py-3 text-2xl lg:text-base'>Sort by: Name<FaAngleDown/></p>
  <GridButton />
</div>
