          ...
          <div className="lg:px-10">
            ...
            <div>
              ...
              <ul className='flex gap-10 font-bold  pt-5'>
                <li className='flex items-center gap-1 '><MdErrorOutline className='mr-2'/>Private<LuDot  className='mr-2'/>Large<LuDot  className='mr-2'/>Urban</li>
                <li className='flex items-center gap-1'><BsTelephone  className='mr-2'/>01-5970012,9860605959</li>
                <li className='flex items-center gap-1'><BsTelephone  className='mr-2'/> ESTD 2002</li>
              </ul>
              <ul className='flex gap-10 font-bold py-8 '>
                <li className='flex items-center gap-2  '><FaGraduationCap  className='mr-2'/>57% Graduation Rate</li>
                <li className='flex items-center gap-2 pl-10'><CiMail className='mr-2'/>info@islington.edu.np</li>
                <li className='flex items-center gap-2 pl-2'><CiMail  className='mr-2'/>islington.np</li>
              </ul>
            </div>
            <div className="border border-gray-300">
              <h3 className="font-bold pb-2 pt-4 px-5">About College</h3>
              <p className="py-4 px-5">
                This is a modern and one of the best colleges in Nepal dedicated to excellence with practical-based education.
                Being an institution with a long history, it has developed many leaders and entrepreneurs.
                It assures that every student is technically competent.
              </p>
        ...
        {activeSection === 'admission' && (
          <div className="lg:px-10 py-10">
            ...
            <div className="grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 gap-6">
              {[1, 2, 3, 4].map((_, index) => (
                <div key={index} className="bg-[#FAFAFA] shadow-lg border border-gray-300 rounded-lg p-5">
                  <Image
                    ...
                    width={300}
                  />
                  <h4 className="text-xl font-bold mt-3 text-[#007296]">BSc Hons Computing</h4>
                  <p className="text-gray-600 text-sm flex items-center gap-1"> <CiClock1/>3 Years <RiCalendarScheduleLine/> Kathmandu, Nepal</p>
                  <p className="text-gray-700 text-sm mt-2">
                    A 3-year IT degree program focused on theoretical and practical knowledge in computing.
                  </p>
            ...
            <h3 className="font-bold pb-5 pt-10 text-center text-3xl">Business Degree</h3>
            <div className="grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 gap-6">
              {[1, 2].map((_, index) => (
                <div key={index} className="bg-white shadow-lg rounded-lg border border-gray-300 p-5">
                  <Image
                    ...
                    width={200}
                  />
                  <h4 className="text-xl font-bold mt-3 text-[#007296]">BBA Hons Business</h4>
                  <p className="text-gray-600 text-sm flex items-center gap-1"><CiClock1/>4 Years <RiCalendarScheduleLine/>  Kathmandu, Nepal</p>
                  <p className="text-gray-700 text-sm mt-2">
                    A 4-year business degree designed for future business leaders and entrepreneurs.
                  </p>
                  <button className="mt-3 w-full bg-orange-500 text-white py-2 rounded-md">
                    View details
                  </button>
